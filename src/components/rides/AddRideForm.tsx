...
const INPUT =
  "w-full rounded-xl border border-slate-700/90 bg-black/20 px-3 py-[11px] text-slate-100 outline-none placeholder:text-slate-400/70 focus:border-blue-400/80";
